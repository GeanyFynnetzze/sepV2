...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MyviewHolder> {
    ...
    private List<CO2Entity> co2List = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull RecycleAdapter.MyviewHolder holder, int position) {
        CO2Entity currentList = co2List.get(position);

        holder.co2Image.setImageResource(R.drawable.ic_justworkco2);
        holder.co2ID.setText("ID : " + String.valueOf(currentList.getCO2_ID()));
        holder.co2Value.setText("Value : " + String.valueOf(currentList.getCO2_value()));
        holder.co2Date.setText("Date : " + currentList.getCO2_date());

    }

    public RecycleAdapter(Context context, List<CO2Entity> co2List) {
        this.context = context;
        this.co2List = co2List;
    }

    public void setCo2List(List<CO2Entity> co2List) {
        this.co2List = co2List;
